        ...
        <div className='bg-pink-500 rounded-xl pb-20'>
          ...
          <form onSubmit={(e) => handleSubmit(e)}>
            <div className='flex flex-col py-2 px-10'>
              ...
              <input type="text" className='bg-white text-black mt-2 px-2 min-md:w-100 py-2 rounded-xl '
            ...
            <div className='flex flex-col py-2 px-10'>
              ...
              <input type="password" className='bg-white text-black mt-2 px-2 min-md:w-100 py-2 rounded-xl '
          ...
          <div className='flex justify-center pt-4'>
            <p>Dont have an account? <Link to="/signup" className='hover:text-blue-800'>Signup</Link></p>
          </div>
        </div>
      </div>
    </>
